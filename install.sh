...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY NDY - OFFICIAL           [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "ndy170610" ]; then
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer NDy - OffiCial   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${WHITE}ggg:     gg.     -   ,ggg       • Telegram : @NDySupport    ${NC}"
  echo -e "${WHITE} ggg:     ggg._    _,ggg        • Credit  : NDy - OffiCial ${NC}"
  echo -e "${WHITE} ggg.    '.'''ggggggp           • Support by NDy - OffiCial  ${NC}"
